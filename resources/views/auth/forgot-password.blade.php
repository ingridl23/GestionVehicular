...
<head>
    ...
    <title>Recuperar contraseña - Gestión Vehicular</title>
            ...
            <div class="backdrop-blur-lg bg-white/30 shadow-xl rounded-xl p-6 border border-white/40">
                ...
                <form method="POST" action="{{ route('password.email') }}">
                    ...
                    <input
                        ...
                        required
                        class="w-full px-4 py-2 mb-4 rounded-lg border border-gray-300 focus:ring focus:ring-blue-300 focus:border-blue-500 @error('email') border-red-500 @enderror"
                    />
