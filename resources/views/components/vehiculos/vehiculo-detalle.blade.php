...
<div class="py-6">
    ...
    <strong>Control Satelital:</strong> {{ $vehiculo->control_satelital ? 'Sí' : 'No' }}<br>
     <strong>Estado Actual Del Vehiculo:</strong> {{ $vehiculo->estadoVehiculo->estado }}
</p>
                        ...
                        <div class="flex justify-end gap-4 mt-8">
                            <button id="btn-editar" class="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                                <svg class="w-6 h-6 text-gray-600 dark:text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <button id="btn-eliminar" class="p-2 rounded-lg hover:bg-red-100 dark:hover:bg-red-900 transition-colors">
